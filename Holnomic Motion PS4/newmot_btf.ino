...
void loop()
{
  ...
  if (PS4.connected())
  {
    ...
    s1 =  sf * (-0.43341 * x + 0.292203 * y + 0.339963 * w);
    s2 =  sf * (-0.688017 * x + -0.380439 * y + 0.492304 * w);
    s3 =  sf * (0.92998 * x + -0.182602 * y + 0.00459724 * w);
    s4 =  sf * (0.191447 * x + 0.270837 * y + 0.163136 * w);
  ...
  sf = (sf > 1.5) ? 2 : sf;
  sf = (sf < 0) ? 0 : sf;
  sf_yaw = (sf_yaw < 0) ? 1 : sf_yaw;
  sf_yaw = (sf_yaw > 2) ? 2 : sf_yaw;
